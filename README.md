...
If you notice there are a lot of questions on AAQ, and the TCs in sync are free, make sure to keep them queued up. You can check the queue by typing `qbot q`. That way each student gets proper one on one support.
...
It is your responsibility to make sure the dispatch role is filled when you your shift ends.
